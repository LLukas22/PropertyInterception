...
namespace PropertyInterception.Tests.Attributes
{
    ...
    internal class ExitAttribute : Attribute, IPropertyGetterInterceptor, IPropertySetterInterceptor
    {
        ...
        {
            (propertyInterceptionInfo.Instance as DummyObject).TriggeredOnExit = true;
        }
